...
public abstract class JavaeeConfigurationType extends J2EEConfigurationType {
    ...
    public LocalizeValue getDisplayName() {
        return JakartaWebServerLocalize.configurationtypeName(myBundleType.getDisplayName());
    }

    @Nonnull
    @Override
    public LocalizeValue getConfigurationTypeDescription() {
        return JakartaWebServerLocalize.configurationtypeDescription(myBundleType.getDisplayName());
    }
