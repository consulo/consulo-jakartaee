...
public interface EntityBean extends EjbWithHome {
  ...
  GenericValue<PersistenceType> getPersistenceType();

  GenericValue<PsiClass> getPrimKeyClass();

  GenericValue<Boolean> getReentrant();

  GenericValue<CmpVersion> getCmpVersion();

  GenericValue<String> getAbstractSchemaName();

  GenericValue<CmpField> getPrimkeyField();
