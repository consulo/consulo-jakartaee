...
public enum EjbDescriptorVersion implements NamedEnum {
  EJB_VERSION_1_X("1.x", EjbRootDescriptor.EJB_JAR_VERSION_1_X, JavaeeVersion.J2EE_1_4,
  ...
  EJB_VERSION_3_2("3.2", EjbRootDescriptor.EJB_JAR_VERSION_3_1, JavaeeVersion.JAVAEE_7);//todo[nik] add template for version 3.2
